...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer className="site-footer"><div className="footer-top"><a className="brand footer-brand" href="#top" aria-label="Back to Jermaine’s home"><span className="brand-mark" aria-hidden="true">J</span><span className="brand-copy"><strong>Jermaine’s</strong><small>eat · drink · love</small></span></a><p>Bright bites.<br /><em>Big heart.</em></p><div className="footer-links"><a href="#menu">Menu</a><a href="#about">About</a><a href="#gallery">Gallery</a><a href="#visit">Visit us</a></div></div><div className="footer-bottom"><div><span>728 N Main St · Gunnison, CO 81230</span><a href="tel:+19706419876">(970) 641-9876</a></div><div className="footer-socials"><a href="https://www.facebook.com/" target="_blank" rel="noreferrer" aria-label="Jermaine’s Facebook placeholder">Facebook</a><a href="https://www.instagram.com/" target="_blank" rel="noreferrer" aria-label="Jermaine’s Instagram placeholder">Instagram</a></div><small>© {new Date().getFullYear()} Jermaine’s · Website designed for Jermaine’s</small></div></footer>
